...
def GenerateBatch(BasePath, DirNamesTrain, TrainLabels, ImageSize, MiniBatchSize, ModelType):
    ...
    if (ModelType  == 'Sup'):
        ...
        while ImageNum < MiniBatchSize:
            ...
            IABatch.append(np.float32(A_normal.reshape(128,128,1)))
...
def TrainOperation(ImgPH, LabelPH,ImageAPH,CornerAPH, PatchBPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    if ModelType == 'Sup':
        ...
        print("Unsupervised")
        pred_PB,PB,H4pt,kernel_c1, kernel_c2, kernel_c3, kernel_c4, kernel_f1, kernel_f2, bias = UnsupervisedModel(ImgPH,ImageAPH,CornerAPH, PatchBPH,ImageSize, MiniBatchSize)
...
def main():
    ...
    Parser.add_argument('--BasePath', default='/home/p_akanksha94/CMSC733/apatel44_smakam_p1/Phase2', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/COCO')
    ...
    Parser.add_argument('--LogsPath', default='Logs/Unsup/Train/', help='Path to save Logs for Tensorboard, Default=Logs/')
    ...
    ImageAPH = tf.placeholder(tf.float32, shape=(MiniBatchSize, 128,128,1))
