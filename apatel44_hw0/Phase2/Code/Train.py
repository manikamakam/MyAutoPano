...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    # prLogits, prSoftMax = CIFAR10ModelMod(ImgPH, ImageSize, MiniBatchSize)    
    prLogits, prSoftMax = resnet(ImgPH, 10, ImageSize)
    # prLogits, prSoftMax = densenet(ImgPH, 10, ImageSize)
    # prLogits, prSoftMax = resnext(ImgPH, 10, ImageSize)
    ...
    with tf.Session() as sess:       
        ...
        for Epochs in tqdm(range(StartEpoch, NumEpochs)):
            ...
            if not os.path.exists('Graphs/ResNet/train/'):
                os.makedirs('Graphs/ResNet/train/')
            plt.savefig('Graphs/ResNet/train/lossEpochs'+str(Epochs)+'.png')
            # plt.show()
            plt.close()
...
def main():
    ...
    Parser.add_argument('--BasePath', default='/home/akanksha/Documents/CMSC733/apatel44_hw0/Phase2/CIFAR10', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/CIFAR10')
    # Parser.add_argument('--BasePath', default='/scratch0/saksham/rough/models/Phase2/CIFAR10', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/CIFAR10')
    ...
    LabelPH = tf.placeholder(tf.float32, shape=(MiniBatchSize, NumClasses), name="output") # OneHOT labels
