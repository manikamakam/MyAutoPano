...
from Network.ModifiedNetwork import CIFAR10ModelMod
...
def TestOperation(ImgPH, ImageSize, ModelPath, DataPath, LabelsPathPred):
    ...
    # _, prSoftMaxS = CIFAR10ModelMod(ImgPH, ImageSize, 1)
    _, prSoftMaxS = resnet(ImgPH, 10, ImageSize)
    # _, prSoftMaxS = resnext(ImgPH, 10, ImageSize)
    # _, prSoftMaxS = densenet(ImgPH, 10, ImageSize)
...
def ConfusionMatrix(LabelsTrue, LabelsPred):
    ...
    plt.ylabel('True')
    # plt.show()
    plt.savefig('Graphs/ResNet/test/test/matrix.png')
    # plt.savefig('Graphs/ResNet/test/train/matrix.png')
    plt.close()
...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/akanksha/Documents/CMSC733/apatel44_hw0/Phase2/Checkpoints/9model.ckpt', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='/home/akanksha/Documents/CMSC733/apatel44_hw0/Phase2/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
    # Parser.add_argument('--BasePath', dest='BasePath', default='/home/akanksha/Documents/CMSC733/apatel44_hw0/Phase2/CIFAR10/Train/', help='Path to load images from, Default:BasePath')
    ...
    for epoch in range(NumEpochs):
        ...
        ModelPath = '/home/akanksha/Documents/CMSC733/apatel44_hw0/Phase2/Checkpoints/ResNet/'+str(epoch)+'model.ckpt'
        # print(ModelPath)
        # BasePath = Args.BasePath
        # LabelsPath = Args.LabelsPath
        ...
        plt.savefig('Graphs/ResNet/test/test/Epochs'+str(epoch)+'.png')
        # plt.savefig('Graphs/ResNet/test/train/Epochs'+str(epoch)+'.png')
        plt.close()
        # ConfusionMatrix(LabelsTrue, LabelsPred, epoch)
    end = time.time()
