...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    with tf.name_scope('Optimizer'):
        ...
        learning_rate = tf.compat.v1.train.exponential_decay(starter_learning_rate,global_step, 300, 0.9, staircase=True)
        # Optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.0005, use_locking=False, name='GradientDescent').minimize(loss)

        # Optimizer = SGD(learning_rate=0.005, momentum=0.9, nesterov=False, decay=1e-6)
        ...
        # Optimizer = tfa.optimizers.SGDW(learning_rate=0.005, weight_decay=0.9, momentum=0.9)
    ...
    with tf.Session() as sess:       
        ...
        for Epochs in tqdm(range(StartEpoch, NumEpochs)):
            ...
            for PerEpochCounter in tqdm(range(NumIterationsPerEpoch)):
                ...
                # Save checkpoint every some SaveCheckPoint's NumIterationsPerEpoch
...
def main():
    ...
    Parser.add_argument('--BasePath', default='/home/manika/Desktop/CMSC733/smakam_p1/Phase2', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/COCO')
    Parser.add_argument('--CheckPointPath', default='../Checkpoints/Sup/', help='Path to save Checkpoints, Default: ../Checkpoints/')
    ...
    Parser.add_argument('--LogsPath', default='Logs/Sup/', help='Path to save Logs for Tensorboard, Default=Logs/')
